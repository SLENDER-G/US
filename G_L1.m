...
DAS_RF1 = DAS_3PW./max(abs(DAS_3PW));
...
maxiter = 30;
tic
[u, v, objective]  = G_SR_v0(Phi,DAS_RF, b, eps, mu, lambda, beta1, beta2, maxiter);
%[x, obj] = G_SR_FISTA_modified(Phi, b, mu, lambda, maxiter, eps);
toc
